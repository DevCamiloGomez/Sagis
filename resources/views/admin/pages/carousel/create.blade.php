                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                name="title" value="{{ old('title') }}" placeholder="Ingrese el título de la imagen">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type') is-invalid @enderror" id="type" name="type">
                                <option value="main" {{ old('type')=='main' ? 'selected' : '' }}>Carrusel Principal
                                </option>
                                <option value="section" {{ old('type')=='section' ? 'selected' : '' }}>Carrusel de
                                    Sección</option>
                            </select>
                            @error('type')
                            <span class="invalid-feedback">{{ $message }}</span>
