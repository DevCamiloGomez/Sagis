...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="card shadow" style="width: 100%; max-width: 600px;">
        <div class="card-body">
            <h3 class="mb-4 text-center">Agregar Trabajo</h3>
            <form action="{{ route('store_jobs') }}" method="POST">
                ...
                <div id="companyFields" style="display: none;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name_compamy_input">
                    </div>
                    @error('name')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" id="email_company_input">
                    </div>
                    @error('email')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address" id="address_company_input">
                    </div>
                    @error('address')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="phone" id="phone_company_input">
                    </div>
                    @error('phone')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="mt-4 text-center">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <div class="ml-5">
                            <a class="btn btn btn-warning" style="color:black; text-decoration: none;" href="{{ route('jobs') }}">Regresar</a>
                        </div>
                    </div>
                </div>
            </form>
...
$(function() {
    ...
    // Mostrar/ocultar campos de empresa solo si es nueva
    function toggleCompanyFields() {
        ...
        if (value === '-2') {
            ...
            $('#companyFields').hide();
            $('#companyFields input').prop('required', false).val('');
        }
    }
    $('#empresas').on('change', toggleCompanyFields);
    toggleCompanyFields();
    ...
    $('input[name="location_type"]').on('change', toggleLocationFields);
