...
Route::resource('job-offers', \App\Http\Controllers\Admin\JobOfferController::class , ['as' => 'admin']);
Route::get('job-offers/{jobOffer}/toggle', [\App\Http\Controllers\Admin\JobOfferController::class , 'toggleStatus'])->name('admin.job-offers.toggle');