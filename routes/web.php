...
// Rutas protegidas para Graduados (Con chequeo de Habeas Data via Global Middleware)
Route::middleware(['auth:web'])->group(function () {
...
Route::get('bolsa-empleo/sistemas', [\App\Http\Controllers\JobOfferController::class , 'index'])->name('job-offers.index');
Route::get('bolsa-empleo/sistemas/{jobOffer}', [\App\Http\Controllers\JobOfferController::class , 'show'])->name('job-offers.show');
...
// Rutas para envío masivo de correos y gestión adicional de graduados
Route::middleware(['auth:admin'])->prefix('admin')->group(function () {
    Route::get('/graduates/mass-email', [\App\Http\Controllers\Admin\GraduateController::class , 'showMassEmailForm'])
        ->name('admin.graduates.mass-email-form');
    Route::post('/graduates/mass-email', [\App\Http\Controllers\Admin\GraduateController::class , 'sendMassEmail'])
